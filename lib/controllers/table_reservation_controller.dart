...
Future<void> confirmReservation([VoidCallback? onSuccess]) async {
  ...
  try {
    ...
    if (reservationResponse.statusCode == 201) {
      ...
      final reservationId = responseBody['id'];
      ...
      confirmationController.addReservation(reservationPayload);

      Get.snackbar("Succès", "Réservation effectuée ✅\nID: $reservationId");
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) {
        try {
          ...
          print("✅ NotificationsController trouvé");
